...
entry:
  ...
  %i = load i32, i32* %a, align 4, !dbg !24
  %add = add nsw i32 1, %i, !dbg !25
  store i32 %add, i32* %b, align 4, !dbg !26
  %i1 = load i32, i32* %a, align 4, !dbg !27
  %add1 = add nsw i32 2, %i1, !dbg !28
  store i32 %add1, i32* %c, align 4, !dbg !29
  %i2 = load i32, i32* %a, align 4, !dbg !30
  %add2 = add nsw i32 3, %i2, !dbg !31
  store i32 %add2, i32* %d, align 4, !dbg !32
  %i3 = load i32, i32* %b, align 4, !dbg !33
  %i4 = load i32, i32* %d, align 4, !dbg !35
  %cmp = icmp slt i32 %i3, %i4, !dbg !36
  br i1 %cmp, label %if.then, label %if.else, !dbg !37

if.then:                                          ; preds = %entry
  %i5 = load i32, i32* %b, align 4, !dbg !38
  %add3 = add nsw i32 %i5, 1, !dbg !40
  store i32 %add3, i32* %a, align 4, !dbg !41
  br label %if.end, !dbg !42

if.else:                                          ; preds = %entry
  %i6 = load i32, i32* %d, align 4, !dbg !43
  %add4 = add nsw i32 %i6, 5, !dbg !45
...
while.cond:                                       ; preds = %while.body, %if.end
  %i7 = load i32, i32* %b, align 4, !dbg !48
  %cmp5 = icmp sgt i32 %i7, 5, !dbg !49
  br i1 %cmp5, label %while.body, label %while.end, !dbg !47

while.body:                                       ; preds = %while.cond
  %i8 = load i32, i32* %b, align 4, !dbg !50
  %sub = sub nsw i32 %i8, 1, !dbg !52
  store i32 %sub, i32* %b, align 4, !dbg !53
  br label %while.cond, !dbg !47, !llvm.loop !54

while.end:                                        ; preds = %while.cond
  %i9 = load i32, i32* %a, align 4, !dbg !57
  %i10 = load i32, i32* %c, align 4, !dbg !58
  %add6 = add nsw i32 %i9, %i10, !dbg !59
  ret i32 %add6, !dbg !60
}
